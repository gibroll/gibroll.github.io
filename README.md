...
<div class="w3-top w3-hide-small">
  <div class="w3-bar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
    ...
    <a href="#about" class="w3-bar-item w3-button">PORTFOLIO</a>
  </div>
</div>
...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
  ...
  <div class="w3-display-middle w3-center">
    <span class="w3-text-white w3-hide-small" style="font-size:100px">Gabriel<br>Visitacion</span>
    <span class="w3-text-white w3-hide-large w3-hide-medium" style="font-size:60px"><b><br></b></span>
    <p><a href="#menu" class="w3-button w3-xxlarge w3-black">CLICK ME</a></p>
  </div>
</header>
  ...
  <div class="w3-content">
    ...
    <div class="w3-row w3-center w3-border w3-border-dark-grey">
      <a href="javascript:void(0)" onclick="openMenu(event, 'Pizza');" id="myLink">
        <div class="w3-col s4 tablink w3-padding-large w3-hover-red">Why AP CSP?</div>
      </a>
      <a href="javascript:void(0)" onclick="openMenu(event, 'Pasta');">
        <div class="w3-col s4 tablink w3-padding-large w3-hover-red">Hobbies</div>
      </a>
      <a href="javascript:void(0)" onclick="openMenu(event, 'Starter');">
        <div class="w3-col s4 tablink w3-padding-large w3-hover-red">Important Google Images</div>
      </a>
    </div>
    ...
    <div id="Starter" class="w3-container menu w3-padding-32 w3-white">
      ...
      <h1><b>Yuki the Seal</b> <span class="w3-right w3-tag w3-dark-grey w3-round">The MOST Important</span></h1>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xlarge" id="about">
  <div class="w3-content">
    ...
    <p></p>
    <img src="/Images/fattiger.jpg" style="width:100%" class="w3-margin-top w3-margin-bottom" alt="Pillow Pet Tiger">
    <h1><b></b></h1>
